...
import samautomation.pageobjects.LandingPage;
...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("samina.kausar.professional@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("8b@2$A2Dy.Ua6Z@");
		...
		// Check if prod is null before attempting to find the element
		if (prod != null) {
		    prod.findElement(By.cssSelector(".card-body button:last-of-type")).click();
		} else {
